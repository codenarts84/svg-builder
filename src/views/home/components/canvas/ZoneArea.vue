  ...
  <g class="area" :transform="transform" @mousedown="mousedown" @mouseup="mouseup"
    ...
    <g v-if="area.shape === 'roundTable'" class="table">
      ...
      <g class="table_seat" v-for="item in area.seats" :key="item"
        ...
        <g v-if="item.tag_name == 'Wheelchair'"
          ...
          <g data-v-e185086c="">
            <path
              ...
              data-v-e185086c=""
              style="stroke: none; fill-rule: nonzero; fill: #0064d0; fill-opacity: 0.7;">
            </path>
            <path
        ...
        <circle
          v-else-if="item.tag_name && item.tag_name !== 'Standing Room Only'"
          :fill="seatColor(item.category)" :cx="item.position.x"
          :cy="item.position.y + 7" :r="3" :stroke="'#000'"
